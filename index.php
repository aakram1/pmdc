	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner">
				...
				<br></br>
<form action="php/apiServices/integration.php" method="get">
	<ul class="actions">
		...
		<input type="text" id="numGuests" name="numguests" placeholder="Number of Guests" /> <input class="button" type="submit" value="Search" /></li>
	</ul>
	</form>
	</section>
